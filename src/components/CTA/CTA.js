    ...
    <div className='relative bg-gray-800'>
      <div className='h-56 bg-red-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2'>
        <img
          ...
          src='https://images.unsplash.com/photo-1525130413817-d45c1d127c42?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=60&blend=FFFFFF&sat=-100&blend-mode=multiply'
          alt='Support team'
        />
      </div>
      <div className='relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16'>
        <div className='md:ml-auto md:w-1/2 md:pl-10'>
          <div className='text-base leading-6 font-semibold uppercase tracking-wider text-red-700'>
            Tech Support
          </div>
          ...
          <p className='mt-3 text-lg leading-7 text-gray-300'>
            Have a question on what Possue can do for you? Feel free to contact
            us online or by phone and we'll try and answer your questions as
